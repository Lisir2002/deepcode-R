...
// 当前版本基线：0.1.5；后续版本号升级必须由用户明确指令
val BASE_VERSION = "0.1.5"

// 版本号策略：
//   1. 仅当 git tag 以 v0.1.5 开头时（如 v0.1.5 / v0.1.5-rc20），沿用 tag 中的后缀；
//   2. 其他情况（tag 为其他版本号 / 无 tag / 无 git 环境），一律 fallback 到 "0.1.5-dev"；
