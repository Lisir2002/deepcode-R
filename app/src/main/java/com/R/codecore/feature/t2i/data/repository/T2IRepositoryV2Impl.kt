...
import com.R.codecore.datalayer.repository.T2iRepository as V2T2iRepository
...
class T2IRepositoryV2Impl @Inject constructor(
    ...
    private fun com.R.codecore.datalayer.sqldelight.t2i.T2i_providers.toEntity() = T2IProviderEntity(
        id = id,
        name = name,
        type = type,
        baseUrl = base_url,
    ...
    private fun com.R.codecore.datalayer.sqldelight.t2i.T2i_provider_models.toEntity() = T2IProviderModelEntity(
        id = id,
    ...
    private fun com.R.codecore.datalayer.sqldelight.t2i.T2i_task.toEntity() = T2ITaskEntity(
        id = id,
