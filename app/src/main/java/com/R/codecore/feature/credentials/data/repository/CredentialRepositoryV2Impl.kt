...
import com.R.codecore.datalayer.repository.CredentialsRepository as V2CredentialsRepository
...
class CredentialRepositoryV2Impl @Inject constructor(
    ...
    private suspend fun com.R.codecore.datalayer.sqldelight.credentials.Git_credentials.toDomain(): GitCredential =
        GitCredential(
            id = id,
            host = host,
            username = username,
