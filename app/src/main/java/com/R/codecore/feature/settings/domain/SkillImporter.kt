...
import com.R.codecore.feature.agent.domain.skill.LocalDirectorySkillSource
 ...
 * SCRIPT 技能仍需模型发起调用且经 [com.R.codecore.feature.agent.domain.skill.SkillExecutor] 强制审批后才执行。
 *
 * 使用流程：
