...
import com.R.codecore.feature.agent.domain.model.CONTEXT_SUMMARY_LEGACY_PREFIX
...
class MessagePersistenceUseCase @Inject constructor(
    ...
    private fun AgentAttachment.toAgentImage(): com.R.codecore.feature.agent.domain.model.AgentImage? {
        ...
        return try {
            ...
            com.R.codecore.feature.agent.domain.model.AgentImage(
