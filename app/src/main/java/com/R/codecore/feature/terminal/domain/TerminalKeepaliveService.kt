...
class TerminalKeepaliveService : Service() {
     ...
     * 不应让进程崩溃（设置页的开关仍是开启态，下次前台时由 [com.R.codecore.MainActivity] 恢复）。
     */
    ...
    companion object {
        ...
        const val ACTION_START_SESSION = "com.R.codecore.action.START_SESSION"
        const val ACTION_STOP_SESSION = "com.R.codecore.action.STOP_SESSION"
        const val ACTION_ENABLE_PERSISTENT = "com.R.codecore.action.ENABLE_PERSISTENT"
        const val ACTION_DISABLE_PERSISTENT = "com.R.codecore.action.DISABLE_PERSISTENT"
