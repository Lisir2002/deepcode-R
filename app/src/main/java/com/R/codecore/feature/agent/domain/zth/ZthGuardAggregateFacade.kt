...
import com.R.codecore.feature.agent.data.repository.ZthCapabilityAuditRepository
import com.R.codecore.feature.agent.data.repository.ZthCheckpointRepository
import com.R.codecore.feature.agent.data.repository.ZthTelemetryRepository
...
class ZthGuardAggregateFacade @Inject constructor(
    ...
    private val confirmationCardVmProvider: javax.inject.Provider<com.R.codecore.feature.agent.presentation.ZthConfirmationCardViewModel>,
    ...
    suspend fun onThrowableAudit(
        ...
        currentCommandPrefix: String? = null,
        httpStatusCode: Int? = null,
        bundleDownloadFailure: com.R.codecore.feature.agent.domain.zth.BundleDownloadResult.Failure? = null
    ...
    private suspend fun triggerCardSuspend(
        vm: com.R.codecore.feature.agent.presentation.ZthConfirmationCardViewModel,
        ...
        val payload = com.R.codecore.feature.agent.presentation.ZthConfirmationCardViewModel.ConfirmationCardPayload(
