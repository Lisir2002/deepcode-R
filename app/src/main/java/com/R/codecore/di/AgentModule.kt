...
import com.R.codecore.core.db.FileMigration
import com.R.codecore.core.db.LightweightSchemaRescue
import com.R.codecore.core.db.MigrationLoader
...
object AgentModule {
    ...
    private fun funnel0AutoRestoreFromCrashBackupIfNeeded(context: Context) {
        val mainDb = context.getDatabasePath("rcodecore_agent_db")
        ...
        val candidates = crashDir.listFiles { f ->
            f.name.startsWith("rcodecore_agent_db_backup_") &&
    ...
    private fun provideAgentDatabaseInternal(@ApplicationContext context: Context): AgentDatabase {
        ...
        val dbFile = context.getDatabasePath("rcodecore_agent_db")
