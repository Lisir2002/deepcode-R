...
import com.deep.rcode.feature.credentials.data.GitCredentialsFileSync
...
class AIEditorApp : Application() {
    ...
    @Inject
    lateinit var executionModeRepository: com.deep.rcode.feature.settings.data.repository.ExecutionModeRepository
    ...
    override fun onCreate() {
        ...
        // 启动即把 Room 凭据 + DataStore 署名落盘到容器持久挂载（/root/.rdeepcode），
