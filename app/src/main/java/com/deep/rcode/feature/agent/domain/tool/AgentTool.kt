...
abstract class AgentTool {
    ...
    open suspend fun executeWithContext(args: Map<String, JsonElement>, context: com.deep.rcode.feature.agent.domain.model.AgentContext): ToolResult {
        return execute(args)
    }
...
interface StreamingAgentTool {
    fun executeStream(args: Map<String, JsonElement>, context: com.deep.rcode.feature.agent.domain.model.AgentContext): Flow<ToolStreamEvent>
}
