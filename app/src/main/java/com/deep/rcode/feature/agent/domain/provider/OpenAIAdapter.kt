package com.deep.rcode.feature.agent.domain.provider

import com.deep.rcode.core.util.AILogger
...
import com.deep.rcode.feature.settings.domain.model.defaultProviderApiPath
import java.io.IOException
import com.deep.rcode.feature.agent.data.remote.openai.ChatCompletionRequest
import com.deep.rcode.feature.agent.data.remote.openai.OpenAIChatMessage
...
import kotlinx.serialization.json.jsonObject
import com.deep.rcode.feature.agent.data.remote.openai.OpenAIToolCall
import com.deep.rcode.feature.agent.data.remote.openai.OpenAIToolDefinition
import com.deep.rcode.feature.agent.data.remote.openai.OpenAIFunctionDefinition
import com.deep.rcode.feature.agent.data.remote.openai.StreamOptions
...
class OpenAIAdapter @Inject constructor(
    ...
    private fun convertToOpenAIToolCall(toolCall: ToolCall): OpenAIToolCall {
        return OpenAIToolCall(
            id = toolCall.id,
            type = "function",
            function = com.deep.rcode.feature.agent.data.remote.openai.OpenAIFunctionCall(
                name = toolCall.name,
