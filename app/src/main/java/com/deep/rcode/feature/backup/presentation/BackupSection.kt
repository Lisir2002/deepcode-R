package com.deep.rcode.feature.backup.presentation
    ...
    if (pendingAction == PendingAction.ExportPassword) {
        PasswordDialog(
            ...
            onConfirm = {
                ...
                password = ""
                pendingAction = null
                exportLauncher.launch("rdeepcode-backup-${System.currentTimeMillis()}.tar.gz")
            },
            onDismiss = {
                password = ""
                pendingAction = null
...
private fun buildImportSummary(context: android.content.Context, stats: com.deep.rcode.feature.backup.domain.RestoreStats): String = buildString {
