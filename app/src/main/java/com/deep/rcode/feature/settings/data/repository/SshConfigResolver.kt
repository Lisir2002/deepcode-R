...
import com.deep.rcode.feature.agent.domain.container.RemoteConnectionConfig
...
suspend fun RemoteConnectionSettings.resolveSshConfigOrNull(
    ...
    if (!connectionId.isNullOrBlank()) {
        ...
        return@runCatching RemoteConnectionConfig(
            ...
            port = port,
            username = username,
            auth = com.deep.rcode.feature.workspace.domain.remote.RemoteAuth.Password(password),
