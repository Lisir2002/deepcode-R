...
fun providerLogoRes(provider: AIProviderConfig?): Int? {
    ...
    return when (provider.type) {
        com.deep.rcode.feature.settings.domain.model.ProviderType.OPENAI -> R.drawable.logo_openai
        com.deep.rcode.feature.settings.domain.model.ProviderType.ANTHROPIC -> R.drawable.logo_anthropic
        com.deep.rcode.feature.settings.domain.model.ProviderType.GEMINI -> R.drawable.logo_gemini
    }
}
...
fun ProviderLogoIcon(
    ...
    if (res != null) {
        val brandKey = when (provider?.type) {
            com.deep.rcode.feature.settings.domain.model.ProviderType.OPENAI -> "openai"
            com.deep.rcode.feature.settings.domain.model.ProviderType.ANTHROPIC -> "anthropic"
            com.deep.rcode.feature.settings.domain.model.ProviderType.GEMINI -> "gemini"
            else -> null
        }
        Image(
