package com.deep.rcode.feature.agent.domain.prompt

import android.content.Context
import com.deep.rcode.core.util.FileLogger
import com.deep.rcode.feature.agent.domain.container.ContainerInstaller
import com.deep.rcode.feature.agent.domain.memory.MemoryRepository
...
class SystemPromptProvider @Inject constructor(
    ...
    private fun resolvePrompt(name: String): String {
        val customDir = File(containerInstaller.rdeepcodeDir, "prompts.custom")
        ...
        val defaultFile = File(File(containerInstaller.rdeepcodeDir, "prompts"), name)
