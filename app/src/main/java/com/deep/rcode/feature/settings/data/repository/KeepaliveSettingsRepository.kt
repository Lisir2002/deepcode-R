 ...
 *
 * 开启后由 [com.deep.rcode.AIEditorApp] 监听本开关，启动
 * [com.deep.rcode.feature.terminal.domain.TerminalKeepaliveService] 的常驻前台通知，
...
class KeepaliveSettingsRepository @Inject constructor(
    ...
    /** 写入开关。实际启停 Service 由 [com.deep.rcode.AIEditorApp] 监听本流统一完成。 */
