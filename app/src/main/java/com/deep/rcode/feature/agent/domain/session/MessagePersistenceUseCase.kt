package com.deep.rcode.feature.agent.domain.session
...
import com.deep.rcode.feature.agent.domain.model.CONTEXT_COMPACTION_MARKER
import com.deep.rcode.feature.agent.domain.model.CONTEXT_SUMMARY_LEGACY_PREFIX
...
class MessagePersistenceUseCase @Inject constructor(
    ...
    private fun AgentAttachment.toAgentImage(): com.deep.rcode.feature.agent.domain.model.AgentImage? {
        ...
        return try {
            ...
            com.deep.rcode.feature.agent.domain.model.AgentImage(
