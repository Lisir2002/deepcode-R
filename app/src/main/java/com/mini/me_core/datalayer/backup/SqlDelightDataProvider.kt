...
import com.mini.me_core.core.data.DataCategory
import com.mini.me_core.core.data.DataProvider
 ...
 *
 * 对齐现有 [com.mini.me_core.core.data.TableDataProvider] 的模式（数据保护契约：任何新存储必须注册进
