...
import com.mini.me_core.feature.agent.domain.playbook.PlaybookGate
 ...
 *   当前阶段（[com.mini.me_core.feature.agent.domain.playbook.PlaybookExecutor.currentStageView]，suspend）
