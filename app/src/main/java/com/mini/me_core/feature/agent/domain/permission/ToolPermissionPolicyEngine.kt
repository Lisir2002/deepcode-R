...
class ToolPermissionPolicyEngine @Inject constructor(
    ...
    suspend fun evaluate(
        ...
        if (mode == com.mini.me_core.feature.agent.domain.model.AgentMode.PLAN && isDangerousTool(toolName, args, capabilities)) {
        ...
        if (mode == com.mini.me_core.feature.agent.domain.model.AgentMode.AUTO) {
