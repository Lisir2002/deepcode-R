 ...
 * - [agents]：引用 `agent: true` 专项 agent 资产名列表；阶段激活时经 [com.mini.me_core.feature.agent.domain.playbook.SubAgentRunner]
 ...
 * - [path]：资产源路径。
 *
 * 与 [com.mini.me_core.feature.agent.domain.sop.SopAsset] 同构（复用 frontmatter 解析 + mtime 懒刷新），
