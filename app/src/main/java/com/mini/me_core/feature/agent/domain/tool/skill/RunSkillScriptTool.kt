package com.mini.me_core.feature.agent.domain.tool.skill
 ...
 * 技能入口脚本，执行前经 [SkillExecutor] 内部的 [com.mini.me_core.feature.agent.domain.tool.ToolPermissionManager]
 * 审批（会话连贯的确认卡），执行后记审计日志。执行参数以 `SKILL_ARG_*` 环境变量注入，
 * 项目路径按 [com.mini.me_core.feature.agent.domain.skill.SkillExecutor] 的容器侧契约注入。
 *
 * **职责边界**：
