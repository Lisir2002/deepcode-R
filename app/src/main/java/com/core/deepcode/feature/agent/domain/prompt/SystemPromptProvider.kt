...
import com.core.deepcode.feature.agent.domain.input.BehaviorModeSource
import com.core.deepcode.feature.agent.domain.input.GoalAdjustEventSource
import com.core.deepcode.feature.agent.domain.input.GoalHintSource
import com.core.deepcode.feature.agent.domain.input.GoalStaleSource
import com.core.deepcode.feature.agent.domain.input.IntentAskSource
import com.core.deepcode.feature.agent.domain.input.LoopAdvisorySource
import com.core.deepcode.feature.agent.domain.input.PlanPendingHintSource
import com.core.deepcode.feature.agent.domain.input.PlaybookStageSource
import com.core.deepcode.feature.agent.domain.memory.MemoryRepository
import com.core.deepcode.feature.agent.domain.memory.MemoryScope
...
import com.core.deepcode.feature.agent.domain.rule.RuleAsset
import com.core.deepcode.feature.agent.domain.rule.RuleLayer
...
import com.core.deepcode.feature.agent.domain.sop.SopRegistry
import com.core.deepcode.feature.agent.domain.workflow.LoopGuardTracker
...
class SystemPromptProvider @Inject constructor(
    ...
    fun enqueueGoalAdjustEvent(sessionId: String, event: com.core.deepcode.feature.agent.domain.input.GoalAdjustEvent): Boolean =
