package com.core.deepcode.feature.agent.domain.model
...
data class AgentContext(
    ...
    /** 当前会话 id：用于把本轮所有 AI 请求/响应落到该会话的日志文件（[com.core.deepcode.core.util.AILogger]）。 */
    val sessionId: String? = null,
    val mode: AgentMode = AgentMode.BUILD,
    /** 当前专项 agent（#1 会话内 agent 切换，design 8.5）：null = 主 agent（默认）。 */
     ...
     */
    val sessionState: com.core.deepcode.feature.agent.domain.tool.ToolSessionState? = null
)
