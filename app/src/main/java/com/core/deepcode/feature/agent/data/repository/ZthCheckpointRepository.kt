...
class ZthCheckpointRepository @Inject constructor(
    ...
    private fun com.core.deepcode.datalayer.sqldelight.agent.Session_checkpoints.toEntity() = CheckpointEntity(
        id = id,
    ...
    private fun com.core.deepcode.datalayer.sqldelight.agent.Checkpoint_file_snapshots.toEntity() = CheckpointFileSnapshotEntity(
        id = id,
