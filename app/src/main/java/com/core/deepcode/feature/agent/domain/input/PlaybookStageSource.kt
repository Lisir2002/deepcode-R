...
import com.core.deepcode.feature.agent.domain.playbook.PlaybookGate
 ...
 *   当前阶段（[com.core.deepcode.feature.agent.domain.playbook.PlaybookExecutor.currentStageView]，suspend）
