...
class TerminalKeepaliveService : Service() {
     ...
     * 不应让进程崩溃（设置页的开关仍是开启态，下次前台时由 [com.core.deepcode.MainActivity] 恢复）。
     */
    ...
    companion object {
        ...
        const val ACTION_START_SESSION = "com.core.deepcode.action.START_SESSION"
        const val ACTION_STOP_SESSION = "com.core.deepcode.action.STOP_SESSION"
        const val ACTION_ENABLE_PERSISTENT = "com.core.deepcode.action.ENABLE_PERSISTENT"
        const val ACTION_DISABLE_PERSISTENT = "com.core.deepcode.action.DISABLE_PERSISTENT"
