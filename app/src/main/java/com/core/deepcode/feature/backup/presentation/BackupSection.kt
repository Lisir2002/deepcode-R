package com.core.deepcode.feature.backup.presentation
...
import com.core.deepcode.feature.backup.data.guard.SentinelVerdict
    ...
    if (pendingAction == PendingAction.ExportPassword) {
        PasswordDialog(
            ...
            onConfirm = {
                ...
                password = ""
                pendingAction = null
                exportLauncher.launch("deepcode-backup-${System.currentTimeMillis()}.tar.gz")
            },
            onDismiss = {
                password = ""
                pendingAction = null
 ...
 *
 * 背景：applicationId 三次变更（com.aicodeeditor → com.deep.rcode → com.core.deepcode），
...
private fun buildImportSummary(context: android.content.Context, stats: com.core.deepcode.feature.backup.domain.RestoreStats): String = buildString {
