...
data class PendingToolPermission(
     ...
     * 由 [com.core.deepcode.feature.agent.domain.permission.ToolPermissionPolicyEngine] 评估后填入。
     */
...
abstract class AgentTool {
     ...
     * 由 [com.core.deepcode.feature.agent.domain.tool.ToolResultTypeRegistry] 统一登记 schema。
     */
    ...
    open suspend fun executeWithContext(args: Map<String, JsonElement>, context: com.core.deepcode.feature.agent.domain.model.AgentContext): ToolResult {
        return execute(args)
    }
...
interface StreamingAgentTool {
    fun executeStream(args: Map<String, JsonElement>, context: com.core.deepcode.feature.agent.domain.model.AgentContext): Flow<ToolStreamEvent>
}
