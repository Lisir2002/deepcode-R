package com.core.deepcode.feature.agent.domain.trajectory

import com.core.deepcode.datalayer.repository.AgentRepository as V2AgentRepository
import com.core.deepcode.datalayer.sqldelight.agent.Agent_trajectories as V2Trajectory
import com.core.deepcode.feature.agent.data.local.entity.TrajectoryEntity
import com.core.deepcode.feature.agent.domain.tool.ToolResult
import com.core.deepcode.feature.agent.domain.tool.ToolResultTypeRegistry
 ...
 * append-only：只插入不更新，删除会话时由 [com.core.deepcode.feature.agent.domain.session.SessionUseCase]
 * 级联清理。
 */
@Singleton
