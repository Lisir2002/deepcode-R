 ...
 *
 * 工具层（[com.core.deepcode.feature.agent.domain.tool.container.ExecuteCommandTool]、
 * [com.core.deepcode.feature.agent.domain.tool.explorer.SearchCodeTool]、
 * [com.core.deepcode.feature.git.domain.GitRepository]）依赖本接口而非具体实现，
 * 由 DI 按当前执行模式注入对应实例。
 *
