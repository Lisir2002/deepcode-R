package com.core.deepcode.feature.credentials.presentation.component
 ...
 * UI 路径与 [com.core.deepcode.feature.credentials.data.CredentialRequestBridge] 监听到的命令行请求都复用本组件。
 *
