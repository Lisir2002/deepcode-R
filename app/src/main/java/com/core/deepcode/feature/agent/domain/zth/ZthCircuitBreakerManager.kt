...
import com.core.deepcode.feature.agent.data.local.entity.HallucinationFuseEntity
...
class ZthCircuitBreakerManager @Inject constructor(
    ...
    private fun com.core.deepcode.datalayer.sqldelight.agent.Zth_hallucination_fuses.toEntity() = HallucinationFuseEntity(
        id = id,
        scope = scope,
        scopeId = scope_id,
        state = state,
