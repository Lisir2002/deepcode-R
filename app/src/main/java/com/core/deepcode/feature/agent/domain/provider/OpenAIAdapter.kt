package com.core.deepcode.feature.agent.domain.provider

import com.core.deepcode.core.network.DeltaAccumulator
import com.core.deepcode.core.network.DeltaAccumulator.Semantic
import com.core.deepcode.core.network.SseFieldExtractor
...
import com.core.deepcode.feature.settings.domain.model.defaultProviderApiPath
import java.io.IOException
import com.core.deepcode.feature.agent.data.remote.openai.ChatCompletionRequest
import com.core.deepcode.feature.agent.data.remote.openai.OpenAIChatMessage
...
import kotlinx.serialization.json.jsonObject
import com.core.deepcode.feature.agent.data.remote.openai.OpenAIToolCall
import com.core.deepcode.feature.agent.data.remote.openai.OpenAIToolDefinition
import com.core.deepcode.feature.agent.data.remote.openai.OpenAIFunctionDefinition
import com.core.deepcode.feature.agent.data.remote.openai.StreamOptions
...
class OpenAIAdapter @Inject constructor(
    ...
    private fun convertToOpenAIToolCall(toolCall: ToolCall): OpenAIToolCall {
        return OpenAIToolCall(
            id = toolCall.id,
            type = "function",
            function = com.core.deepcode.feature.agent.data.remote.openai.OpenAIFunctionCall(
                name = toolCall.name,
