...
import com.core.deepcode.core.data.DataBlob
import com.core.deepcode.core.data.DataRegistry
...
import com.core.deepcode.datalayer.sqldelight.agent.Agent_session as V2AgentSession
import com.core.deepcode.datalayer.sqldelight.agent.Todo_items as V2TodoItem
import com.core.deepcode.feature.agent.data.local.entity.AgentMessageEntity
import com.core.deepcode.feature.agent.data.local.entity.ChatSessionEntity
import com.core.deepcode.feature.agent.data.local.entity.TodoItemEntity
import com.core.deepcode.feature.agent.domain.mcp.McpConfigRepository
import com.core.deepcode.feature.agent.domain.mcp.McpManager
import com.core.deepcode.feature.agent.domain.permission.PermissionRulesRepository
import com.core.deepcode.feature.backup.domain.AgentMessageDto
import com.core.deepcode.feature.backup.domain.BackupCrypto
import com.core.deepcode.feature.backup.domain.BackupDecryptionException
import com.core.deepcode.feature.backup.domain.BackupManager
import com.core.deepcode.feature.backup.domain.BackupMetadata
import com.core.deepcode.feature.backup.domain.BackupOptions
import com.core.deepcode.feature.backup.domain.BackupSnapshot
import com.core.deepcode.feature.backup.domain.ChatSessionDto
import com.core.deepcode.feature.backup.domain.GitCredentialDto
import com.core.deepcode.feature.backup.domain.ProviderDto
import com.core.deepcode.feature.backup.domain.RemoteConnectionDto
import com.core.deepcode.feature.backup.domain.RemoteMountDto
import com.core.deepcode.feature.backup.domain.RestoreStats
import com.core.deepcode.feature.backup.domain.TodoItemDto
import com.core.deepcode.feature.backup.domain.toMetadata
import com.core.deepcode.feature.credentials.data.local.entity.GitCredentialEntity
import com.core.deepcode.feature.settings.data.local.entity.AIProviderEntity
...
import com.core.deepcode.feature.settings.data.repository.LogSettingsRepository
import com.core.deepcode.feature.settings.data.repository.SyncSettingsRepository
...
import com.core.deepcode.feature.workspace.data.local.entity.RemoteConnectionEntity
import com.core.deepcode.feature.workspace.data.local.entity.RemoteMountEntity
...
class BackupManagerImpl @Inject constructor(
    ...
    private val settingsRepo: com.core.deepcode.datalayer.repository.SettingsRepository,
    private val credentialsRepo: com.core.deepcode.datalayer.repository.CredentialsRepository,
    ...
    private suspend fun com.core.deepcode.datalayer.sqldelight.settings.Ai_providers.toV2Dto(): ProviderDto {
    ...
    private suspend fun com.core.deepcode.datalayer.sqldelight.credentials.Git_credentials.toV2Dto(): GitCredentialDto {
    ...
    private suspend fun com.core.deepcode.datalayer.sqldelight.workspace.Remote_connections.toV2Dto(): RemoteConnectionDto {
    ...
    private fun com.core.deepcode.datalayer.sqldelight.workspace.Remote_mounts.toV2Dto() =
