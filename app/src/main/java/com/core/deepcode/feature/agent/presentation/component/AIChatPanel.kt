...
import com.core.deepcode.core.theme.Brand
...
import com.core.deepcode.feature.agent.presentation.AgentUIMessage
...
import com.core.deepcode.feature.agent.presentation.ConversationSkillsViewModel
import com.core.deepcode.feature.agent.presentation.MessageRole
import com.core.deepcode.feature.agent.presentation.hasVisibleContent
...
fun AIChatPanel(
    ...
    val sendMessage: () -> Unit = {
        ...
        if (text.isNotEmpty() || pendingAttachments.isNotEmpty()) {
            ...
            val sendImages = when (val m = activeModelMetadata) {
                null -> true
                else -> m.supportsVision || m.source == com.core.deepcode.feature.settings.domain.model.ModelMetadata.Source.INFERRED
            }
    ...
    val isRemote = executionMode == com.core.deepcode.feature.settings.data.repository.ExecutionMode.REMOTE_SSH
        ...
        Column(
            ...
            Box(modifier = Modifier.weight(1f)) {
                if (!messagesReady) {
                    ...
                    if (isRemote && connectionState != null && connectionState != com.core.deepcode.feature.agent.domain.container.ConnectionState.CONNECTED) {
...
private fun EditingMessageBanner(
    ...
    Surface(
        shape = androidx.compose.foundation.shape.RoundedCornerShape(com.core.deepcode.core.theme.Radius.md),
