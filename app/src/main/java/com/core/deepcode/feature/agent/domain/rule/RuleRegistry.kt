package com.core.deepcode.feature.agent.domain.rule
 ...
 *
 * - **四级资产**：全局（`deepcodeDir/global-rules.md`）/ 项目（`AGENTS.md`，已有）/
...
class RuleRegistry @Inject constructor(
    ...
    private val core = RuleAssetCore(
        globalRulesFile = { File(containerInstaller.deepcodeDir, GLOBAL_RULES_FILE) },
 ...
 * 未变则复用缓存，变了才重扫 —— 对齐 [com.core.deepcode.feature.agent.domain.prompt.AgentAssetCore] 做法。
 */
