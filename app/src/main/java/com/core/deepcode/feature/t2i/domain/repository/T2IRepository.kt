package com.core.deepcode.feature.t2i.domain.repository
 ...
 *
 * 目的：把 [com.core.deepcode.feature.agent.domain.tool.image.GenerateImageTool] 与
 * [com.core.deepcode.feature.t2i.domain.permission.T2IPermissionPolicyEngine] 从 Room DAO
 * 解耦，使业务读源可按 [com.core.deepcode.datalayer.DataReadMode] 在 Room / V2 间切换。
 *
