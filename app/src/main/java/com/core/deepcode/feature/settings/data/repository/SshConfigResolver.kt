...
import com.core.deepcode.feature.agent.domain.container.RemoteConnectionConfig
...
suspend fun RemoteConnectionSettings.resolveSshConfigOrNull(
    ...
    if (!connectionId.isNullOrBlank()) {
        ...
        return@runCatching RemoteConnectionConfig(
            ...
            port = port,
            username = username,
            auth = com.core.deepcode.feature.workspace.domain.remote.RemoteAuth.Password(password),
