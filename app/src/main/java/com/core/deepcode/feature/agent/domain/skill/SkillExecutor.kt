 ...
 *   （由 [com.core.deepcode.feature.agent.domain.tool.skill.LoadSkillTool] / [com.core.deepcode.feature.agent.domain.tool.skill.RunSkillScriptTool]
 *   在类型分流时给出）。
 *
...
class SkillExecutor @Inject constructor(
    ...
    private suspend fun executeScript(
        ...
        // 容器内技能目录映射：宿主 deepcodeDir 绑定到 /root/.deepcode
        val containerSkillDir = "/root/.deepcode/skills/${skill.id}"
