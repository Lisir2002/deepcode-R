...
import com.core.deepcode.feature.agent.data.repository.ZthCapabilityAuditRepository
import com.core.deepcode.feature.agent.data.repository.ZthCheckpointRepository
import com.core.deepcode.feature.agent.data.repository.ZthTelemetryRepository
import com.core.deepcode.feature.agent.domain.model.AgentMode
import com.core.deepcode.feature.agent.domain.permission.FailureClass
import com.core.deepcode.feature.agent.domain.permission.FailureClassification
import com.core.deepcode.feature.agent.domain.permission.FailureSubClass
...
class ZthGuardAggregateFacade @Inject constructor(
    ...
    private val confirmationCardVmProvider: javax.inject.Provider<com.core.deepcode.feature.agent.presentation.ZthConfirmationCardViewModel>,
    ...
    suspend fun onThrowableAudit(
        ...
        currentCommandPrefix: String? = null,
        httpStatusCode: Int? = null,
        bundleDownloadFailure: com.core.deepcode.feature.agent.domain.zth.BundleDownloadResult.Failure? = null
    ...
    private suspend fun triggerCardSuspend(
        vm: com.core.deepcode.feature.agent.presentation.ZthConfirmationCardViewModel,
        ...
        val payload = com.core.deepcode.feature.agent.presentation.ZthConfirmationCardViewModel.ConfirmationCardPayload(
