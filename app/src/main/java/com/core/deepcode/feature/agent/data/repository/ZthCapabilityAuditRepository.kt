...
import com.core.deepcode.feature.agent.data.local.entity.L0SoftCompactRestoreLogEntity
import com.core.deepcode.feature.agent.domain.zth.ZthCapabilityAuditResult
...
class ZthCapabilityAuditRepository @Inject constructor(
    ...
    private fun com.core.deepcode.datalayer.sqldelight.agent.Zth_l0_soft_compact_restore_logs.toEntity() = L0SoftCompactRestoreLogEntity(
        id = id,
