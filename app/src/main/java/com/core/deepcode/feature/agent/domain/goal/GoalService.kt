package com.core.deepcode.feature.agent.domain.goal

import com.core.deepcode.datalayer.repository.AgentRepository as V2AgentRepository
import com.core.deepcode.datalayer.sqldelight.agent.Agent_goals as V2AgentGoal
import com.core.deepcode.feature.agent.data.local.entity.GoalEntity
import com.core.deepcode.feature.agent.data.local.entity.GoalStatus
...
class GoalService @Inject constructor(
    ...
    suspend fun getById(goalId: String): GoalEntity? =
        v2Agent.getGoalById(goalId)?.toEntity()
    ...
    suspend fun updateText(goalId: String, newText: String): GoalEntity? {
        val existing = v2Agent.getGoalById(goalId)?.toEntity() ?: return null
