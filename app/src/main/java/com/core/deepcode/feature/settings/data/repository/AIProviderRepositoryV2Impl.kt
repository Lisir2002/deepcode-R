...
import com.core.deepcode.datalayer.repository.SettingsRepository as V2SettingsRepository
...
class AIProviderRepositoryV2Impl @Inject constructor(
    ...
    private suspend fun com.core.deepcode.datalayer.sqldelight.settings.Ai_providers.toDomainModel(): AIProviderConfig {
