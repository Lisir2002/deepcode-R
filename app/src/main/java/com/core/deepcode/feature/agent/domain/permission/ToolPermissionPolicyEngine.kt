...
class ToolPermissionPolicyEngine @Inject constructor(
    ...
    suspend fun evaluate(
        ...
        if (mode == com.core.deepcode.feature.agent.domain.model.AgentMode.PLAN && isDangerousTool(toolName, args, capabilities)) {
        ...
        if (mode == com.core.deepcode.feature.agent.domain.model.AgentMode.AUTO) {
