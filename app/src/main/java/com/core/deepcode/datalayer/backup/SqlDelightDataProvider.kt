package com.core.deepcode.datalayer.backup

import app.cash.sqldelight.db.QueryResult
import app.cash.sqldelight.db.SqlDriver
import com.core.deepcode.core.data.DataBlob
import com.core.deepcode.core.data.DataCategory
import com.core.deepcode.core.data.DataProvider
 ...
 *
 * 对齐现有 [com.core.deepcode.core.data.TableDataProvider] 的模式（数据保护契约：任何新存储必须注册进
