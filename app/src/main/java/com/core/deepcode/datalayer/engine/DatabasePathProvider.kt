 ...
 * 使 [com.core.deepcode.datalayer.migration.MigrationEngine] 的快照/回滚可在 JVM 单测覆盖。
 */
/**
...
enum class LibName(val fileName: String) {
    AGENT("deepcode_agent_v3.db"),
    CREDENTIALS("deepcode_credentials_v2.db"),
    SETTINGS("deepcode_settings_v2.db"),
    WORKSPACE("deepcode_workspace_v2.db"),
    T2I("deepcode_t2i_v2.db"),
    INFRA("deepcode_infra_v2.db"),
}
