package com.core.deepcode.core.environment
...
object EnvironmentDetector {
    ...
    fun defaultProfileId(): String =
        if (hostIsX86_64) com.core.deepcode.feature.agent.domain.container.ContainerProfile.BUILTIN_X86_ID
        else com.core.deepcode.feature.agent.domain.container.ContainerProfile.BUILTIN_ID
