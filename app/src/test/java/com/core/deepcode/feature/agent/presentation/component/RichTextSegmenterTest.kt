...
import com.core.deepcode.feature.agent.presentation.component.richsegment.Inline
import com.core.deepcode.feature.agent.presentation.component.richsegment.RichSegment
import com.core.deepcode.feature.agent.presentation.component.richsegment.RichTextSegmenter
...
class RichTextSegmenterTest {
    ...
    fun longComposeSample() {
        val input = """
            ...
            ```xml
            <manifest package="com.core.deepcode">
              <application>
