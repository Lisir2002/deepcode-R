...
-keep class com.R.codecore.feature.agent.data.remote.** { *; }
...
-keepclassmembers class com.R.codecore.** {
    <init>();
}
...
-keep,includedescriptorclasses class com.R.codecore.**$$serializer { *; }
-keepclassmembers class com.R.codecore.** {
    *** Companion;
}
-keepclasseswithmembers class com.R.codecore.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.R.codecore.**.entity.** { *; }   # Room @Entity 不可混淆列名映射
