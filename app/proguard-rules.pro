...
-keep class com.core.deepcode.feature.agent.data.remote.** { *; }
...
-keepclassmembers class com.core.deepcode.** {
    <init>();
}
...
-keep,includedescriptorclasses class com.core.deepcode.**$$serializer { *; }
-keepclassmembers class com.core.deepcode.** {
    *** Companion;
}
-keepclasseswithmembers class com.core.deepcode.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.core.deepcode.**.entity.** { *; }   # Room @Entity 不可混淆列名映射
