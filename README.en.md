...
1. Go to the [Releases page](https://github.com/Lisir2002/deepcode-R/releases) and download the latest APK (`minime-<tag>.apk` — one universal package for both physical devices and emulators).
